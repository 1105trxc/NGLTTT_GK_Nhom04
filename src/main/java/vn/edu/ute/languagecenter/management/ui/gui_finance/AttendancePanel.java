...
public class AttendancePanel extends JPanel {
    ...
    private JPanel buildTopPanel() {
        ...
        g.gridx = 2; g.weightx = 0; pnl.add(new JLabel("Ngày:"), g);
        ...
        g.gridx = 0; g.gridy = 1; g.gridwidth = 6; g.weightx = 1;
    ...
    private JPanel buildTablePanel() {
        ...
        // Editor: JComboBox cho cột Status
        ...
        // Renderer: tô màu theo trạng thái
        tblAttendance.getColumnModel().getColumn(COL_STATUS)
    ...
    private JPanel buildSouthPanel() {
        ...
        pnl.add(btnAllPresent); pnl.add(btnAllAbsent);
        return pnl;
    }
    ...
    private void loadAttendanceTable() {
        ...
        try {
            // Lambda: filter Enrolled → map Student → sort tên
            ...
            // Lambda: index điểm danh đã có theo studentId
    ...
    private void saveAttendance() {
        ...
        for (int i = 0; i < tableModel.getRowCount(); i++) {
            ...
            statusMap.put(stub, st);
            noteMap.put(stub, (String) tableModel.getValueAt(i, COL_NOTE));
        }
        try {
            // Gọi AttendanceService.saveSession() — upsert dựa trên UNIQUE constraint
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            f.setSize(800, 550); f.add(new AttendancePanel());
